...
$userRow = mysqli_fetch_array($res, MYSQLI_ASSOC);
    ...
    if (isset($_POST['submit'])) {
        ...
        if(!empty($_FILES['foto']))
        {
            ...
            $path = "c:/xampp/htdocs/webProgramming/sistemInformasiAlumni/upload/";
    ...
    <div class="container">
        <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">                
                    <input type="text" name="jenjang_studi" id="jenjang_studi" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">                
                    <input type="text" name="propinsi_asal" id="propinsi_asal" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">    
                    <input type="submit" name="submit" value="Create Mahasiswa" class="btn btn-primary btn-block">
                </div>
            </div>
