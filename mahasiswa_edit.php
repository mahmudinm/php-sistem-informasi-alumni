...
$userRow = mysqli_fetch_array($res, MYSQLI_ASSOC);
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "UPDATE users SET username='$username', email='$email', program_studi='$program_studi', jenjang_studi='$jenjang_studi', tanggal_masuk='$tanggal_masuk', propinsi_asal='$propinsi_asal', alamat_rumah='$alamat_rumah', kode_pos='$kode_pos', kota='$kota', nama_sekolah='$nama_sekolah', tempat_lahir='$tempat_lahir', agama='$agama', handphone='$handphone', foto='$foto', status='$status' WHERE nim='$nim'";
