    ...
    <div class="container">
        <form action="" method="POST" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">                
                    <input type="text" name="nama" id="nama" class="form-control" value="<?= $lowongan['nama']; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">                
                    <textarea name="deskripsi" id="deskripsi" class="form-control" style="height: 200px;"><?= $lowongan['deskripsi']; ?></textarea>
                </div>
            </div>
